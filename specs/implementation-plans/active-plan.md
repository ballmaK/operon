...
- [ ] M12: Tauri spawn sidecar + /health polling until running (ref: docs/prd/modules/M12-platform-shell.md DF-M12-01/02)
- [ ] M12: System tray — show/hide/quit menu (ref: docs/prd/modules/M12-platform-shell.md P-M12-02)
- [ ] M12: Docker Desktop env check — fail blocks Sidecar start (ref: M12 PL-02a, C02)
- [ ] M12: Platform DATA_DIR / LOG_DIR / TEMP_DIR resolution (ref: docs/prd/modules/M12-platform-shell.md)
